...
/**
 * Event received when a scheduled order is placed
 */
class OrderScheduledEvent extends WebhookEvent
{
    ...
    public function __construct(array $data)
    {
        ...
        if (! isset($data['meta']['resource_id'], $data['meta']['status'])) {
            throw new \InvalidArgumentException('Missing required scheduled order data');
        }
